...
class MysqliDb
{
    ...
    public function connect()
    {
        ...
        $this->_mysqli->query("SET time_zone = 'Asia/Taipei'");
    }
    /**
...
//$mysqli = new mysqli ('localhost', 'listones_wastew', 'JuzG^b{!&7oP', 'listones_wastewater');
$db = new MysqliDb (Array (
                'host' => 'localhost',
                'username' => 'yo178', 
                'password' => 'g7NTVTVPVIrt3HZo',
                'db'=> 'listones_wastewater',
                'charset' => 'utf8'));
?>
